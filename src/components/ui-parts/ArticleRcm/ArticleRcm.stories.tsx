...
import ArticleRcm from './index';

export default {
  title: 'ui-parts/ArticleRcm',
  component: ArticleRcm,
} as ComponentMeta<typeof ArticleRcm>;
...
export const Default1: ComponentStory<typeof ArticleRcm> = () => (
  <ArticleRcm blogData={data} />
);
